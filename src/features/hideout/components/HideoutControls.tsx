			...
			<div className="flex flex-wrap items-center gap-2">
				<button
					...
					className={`text-xs font-bold border border-border-color px-3 py-2 rounded uppercase tracking-widest transition-colors ${
						hideRequirements ? "bg-white/10 text-white border-white/20" : "text-gray-400 hover:bg-white/5"
					}`}
				>
				...
				<button
					...
					className={`text-xs font-bold border border-border-color px-3 py-2 rounded uppercase tracking-widest transition-colors ${
						hideMoney ? "bg-white/10 text-white border-white/20" : "text-gray-400 hover:bg-white/5"
					}`}
				>
				...
				<button
					...
					className={`text-xs font-bold border border-border-color px-3 py-2 rounded uppercase tracking-widest transition-colors ${
						showHidden ? "bg-white/10 text-white border-white/20" : "text-gray-400 hover:bg-white/5"
					}`}
				>
				...
				<div className="flex items-center border border-border-color rounded overflow-hidden">
					<button
						...
						className={`px-3 py-2 text-xs font-bold uppercase tracking-widest transition-colors ${
							!compactMode ? "bg-white/10 text-white" : "text-gray-400 hover:bg-white/5"
						}`}
						title="Expanded View"
					>
						<Rows2 size={16} />
