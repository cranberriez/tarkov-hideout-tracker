            ...
            <div className="flex flex-col gap-3 rounded-md border border-white/10 bg-black/20 p-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-sm border border-white/10 bg-white/5 px-3 py-2 text-sm font-semibold uppercase tracking-wide text-gray-300 transition-colors hover:border-white/20 hover:bg-white/10 hover:text-white"
                    >
                        <Upload size={16} />
                        Upload Logs
                    </button>
