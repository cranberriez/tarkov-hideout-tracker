			...
			<div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-6">
				<div className="flex items-center gap-3 min-w-0">
					...
					<div className="flex flex-col leading-none min-w-0">
						...
						<span className="text-[10px] sm:text-xs text-gray-500 tracking-wide">STATION MANAGER</span>
					</div>
				</div>

				<div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm font-medium text-gray-400">
					<Link href="/items" className="hover:text-white transition-colors flex items-center gap-2">
						<List size={16} />
						Items
					</Link>
					<Link href="/hideout" className="hover:text-white transition-colors flex items-center gap-2">
						<House size={16} />
						Hideout
					</Link>
					<button
