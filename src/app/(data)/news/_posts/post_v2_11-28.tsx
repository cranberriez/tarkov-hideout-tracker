...
export function Post_v2_11_28() {
    return (
        <NewsPost title="Version 2.0 Major Update" date="November 28, 2025" version="2.0">
            <p className="text-lg">
            ...
            <p>
                ...
                still need to finish your benches without guessing.
            </p>
            <PostImage
                label="Screenshot of Individual Item Counts UI"
                src="/images/news/v2/items-with-counters.png"
            />
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4">
                Hideout Station Statuses and Item Consumption
            </h3>
            <p>
            ...
            <ul>
                ...
                <li>
                    <span className="font-mono">(nothing shown) </span> This station is missing
                    either specific Items or other station levels. Missing station levels are shown
            ...
            <PostImage
                label="Screenshot of Hideout stations at varying levels of Upgradeability"
                src="/images/news/v2/hideout-statuses.png"
                contain
            />
            ...
            <PostImage
                ...
                src="/images/news/v2/quick-add-items.png"
                contain
            />

            <h3 className="text-xl font-semibold mt-4">Found in Raid (FiR) vs. Non-FiR</h3>
            <p>
                There is now a strict separation between <strong>Found in Raid</strong> and{" "}
                <strong>Non-Found in Raid</strong> items. On the Items page, you will clearly see if
                ANY items for a specific requirement need to be Found in Raid.
            </p>
            <p>
                This separation is necessary to properly track and display the differences, ensuring
            ...
            <p>
                ...
                Some new display settings are available within the Settings menu (accessible via the
                new menu button). These settings were moved there to avoid overcrowding the controls
                on individual pages.
            </p>
            ...
            <div className="mt-8 p-4 bg-secondary/20 rounded-lg border border-secondary/50">
                ...
                <ul className="list-disc list-inside space-y-2">
                    <li>
                        We plan to add visibility for items that can be bartered for or crafted with
                        your current station levels.
                    </li>
                    <li>
                        A potential new page for custom lists or the ability to pin crafts for quick
                        reference on the item page.
                    </li>
                    <li>
                        Adding Quests (and Kappa items) is still being considered. While useful, we
                        know many resources already exist for this.
                    </li>
                </ul>
            </div>
