...
The normalized full-quest Redis cache is `quests:full:v14:{regular|pve|pvp-season}`. The current version includes objective geometry and ID-only standard-item references.
